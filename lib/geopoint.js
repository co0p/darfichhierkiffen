  ...
  */
    ...
    export class GeoPoint {
      ...
      if (inRadians === true) {
        this._degLat = this.radiansToDegrees(lat);
        this._degLon = this.radiansToDegrees(lon);
        this._radLat = lat;
        this._radLon = lon;
      } else {
        this._degLat = lat;
        this._degLon = lon;
        this._radLat = this.degreesToRadians(lat);
        this._radLon = this.degreesToRadians(lon);
      }
